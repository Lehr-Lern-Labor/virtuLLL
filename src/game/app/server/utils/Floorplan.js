...
const Floorplan = Object.freeze({
    ...
    FOYER: {
        ...
        NPCS: [
            ...
            {name: "Willkommen", position: [14, 1], direction: Direction.DOWNLEFT, dialog: ["<b>Willkommen beim Digitalkongress!</b><br><br>Schauen Sie sich in Ruhe im virtuLLL um. Bei Fragen helfen Ihnen unsere Moderatoren, zu erkennen an den grünen Namensschildern, gerne weiter.","Notieren Sie Ihre Gedanken auf unserem <a href='https://jamboard.google.com/d/1mbfLYWJE1aaN-JAzG-VVT2U7QQbWyeSqXcEzIAaOlck/edit?usp=sharing' target='__blank'>Jamboard</a>. Hier finden Sie auch weitere Hinweise für ihren Besuch."]},
        ]
    },
    ...
    // GAMING: {
        ...
        // OBJECTS: [   
            ...
            // // Team Blue
            // {type: GameObjectType.TABLE, variation: 0, position: [3,2], isClickable: true, iFrameData: {
                // title: "Team Blue 1", 
                // url: "https://media.lehr-lern-labor.info/collab/p/blue1?showControls=false&showChat=false&showLineNumbers=false&useMonospaceFont=false&noColors=true&chatAndUsers=false", 
                // width: 1000, 
                // height: 600 
            // }},
            // {type: GameObjectType.TABLE, variation: 0, position: [7,2], isClickable: true, iFrameData: {
                // title: "Team Blue 2", 
                // url: "https://media.lehr-lern-labor.info/collab/p/blue2?showControls=false&showChat=false&showLineNumbers=false&useMonospaceFont=false&noColors=true&chatAndUsers=false", 
                // width: 1000, 
                // height: 600 
            // }},
            // {type: GameObjectType.CHAIR, variation: 7*4 + 0, position: [[3,7],1]},
            // {type: GameObjectType.CHAIR, variation: 7*4 + 1, position: [[2,6],2]},
            // {type: GameObjectType.CHAIR, variation: 7*4 + 2, position: [[3,7],3]},
            // {type: GameObjectType.CHAIR, variation: 7*4 + 3, position: [[4,8],2]},
            
            // // Team White
            // {type: GameObjectType.TABLE, variation: 0, position: [3,[6,7]], isClickable: true, iFrameData: {
                // title: "Team White 1", 
                // url: "https://media.lehr-lern-labor.info/collab/p/white1?showControls=false&showChat=false&showLineNumbers=false&useMonospaceFont=false&noColors=true&chatAndUsers=false", 
                // width: 1000, 
                // height: 600 
            // }},
            // {type: GameObjectType.TABLE, variation: 0, position: [7,[6,7]], isClickable: true, iFrameData: {
                // title: "Team White 2", 
                // url: "https://media.lehr-lern-labor.info/collab/p/white2?showControls=false&showChat=false&showLineNumbers=false&useMonospaceFont=false&noColors=true&chatAndUsers=false", 
                // width: 1000, 
                // height: 600 
            // }},
            // {type: GameObjectType.CHAIR, variation: 9*4 + 0, position: [[3,7],5]},
            // {type: GameObjectType.CHAIR, variation: 9*4 + 1, position: [[2,6],6]},
            // {type: GameObjectType.CHAIR, variation: 9*4 + 1, position: [[2,6],7]},
            // {type: GameObjectType.CHAIR, variation: 9*4 + 2, position: [[3,7],8]},
            // {type: GameObjectType.CHAIR, variation: 9*4 + 3, position: [[4,8],6]},
            // {type: GameObjectType.CHAIR, variation: 9*4 + 3, position: [[4,8],7]},
            
            // // Team Orange
            // {type: GameObjectType.TABLE, variation: 0, position: [3,11], isClickable: true, iFrameData: {
                // title: "Team Orange 1", 
                // url: "https://media.lehr-lern-labor.info/collab/p/orange1?showControls=false&showChat=false&showLineNumbers=false&useMonospaceFont=false&noColors=true&chatAndUsers=false", 
                // width: 1000, 
                // height: 600 
            // }},
            // {type: GameObjectType.TABLE, variation: 0, position: [7,11], isClickable: true, iFrameData: {
                // title: "Team Orange 2", 
                // url: "https://media.lehr-lern-labor.info/collab/p/orange2?showControls=false&showChat=false&showLineNumbers=false&useMonospaceFont=false&noColors=true&chatAndUsers=false", 
                // width: 1000, 
                // height: 600 
            // }},
            // {type: GameObjectType.CHAIR, variation: 2*4 + 0, position: [[3,7],10]},
            // {type: GameObjectType.CHAIR, variation: 2*4 + 1, position: [[2,6],11]},
            // {type: GameObjectType.CHAIR, variation: 2*4 + 2, position: [[3,7],12]},
            // {type: GameObjectType.CHAIR, variation: 2*4 + 3, position: [[4,8],11]},
            
            // // Codenames
            // {type: GameObjectType.TABLE, variation: 0, position: [11,[5,6,7,8]], isClickable: true, iFrameData: {
                // title: "Codenames", 
                // url: "https://media.lehr-lern-labor.info/collab/p/codenames?showControls=false&showChat=false&showLineNumbers=false&useMonospaceFont=false&noColors=true&chatAndUsers=false", 
                // width: 1000, 
                // height: 600 
            // }},
            // {type: GameObjectType.CHAIR, variation: 6*4 + 1, position: [10,[5,6,7,8]]},
            // {type: GameObjectType.CHAIR, variation: 3*4 + 3, position: [12,[5,6,7,8]]},
            
            // // Skribbl.io
            // {type: GameObjectType.TABLE, variation: 0, position: [[15,2],[15,3],[15,4],[16,2],[16,3],[16,4],[17,2],[17,3],[17,4]], isClickable: true, iFrameData: {
                // title: "Skribbl.io", 
                // url: "https://media.lehr-lern-labor.info/collab/p/skribbl?showControls=false&showChat=false&showLineNumbers=false&useMonospaceFont=false&noColors=true&chatAndUsers=false", 
                // width: 1000, 
                // height: 600 
            // }},
            // {type: GameObjectType.CHAIR, variation: 8*4 + 0, position: [[15,16,17],1]},
            // {type: GameObjectType.CHAIR, variation: 8*4 + 1, position: [14,[2,3,4]]},
            // {type: GameObjectType.CHAIR, variation: 8*4 + 2, position: [[15,16,17],5]},
            // {type: GameObjectType.CHAIR, variation: 8*4 + 3, position: [18,[2,3,4]]},
            
            // // Skribbl.io
            // {type: GameObjectType.TABLE, variation: 0, position: [[15,9],[15,10],[15,11],[16,9],[16,10],[16,11],[17,9],[17,10],[17,11]], isClickable: true, iFrameData: {
                // title: "Stadt, Land, Fluss", 
                // url: "https://media.lehr-lern-labor.info/collab/p/slf?showControls=false&showChat=false&showLineNumbers=false&useMonospaceFont=false&noColors=true&chatAndUsers=false", 
                // width: 1000, 
                // height: 600 
            // }},
            // {type: GameObjectType.CHAIR, variation: 8*4 + 0, position: [[15,16,17],8]},
            // {type: GameObjectType.CHAIR, variation: 8*4 + 1, position: [14,[9,10,11]]},
            // {type: GameObjectType.CHAIR, variation: 8*4 + 2, position: [[15,16,17],12]},
            // {type: GameObjectType.CHAIR, variation: 8*4 + 3, position: [18,[9,10,11]]},
    ...
    SC_SE: {
        ID: Settings.SC_SE_ID,
        NAME: "Science Camp Softwareentwicklung",
        TYPE: TypeOfRoom.CUSTOM,
        LENGTH: 10,
        WIDTH: 10,
        MAPELEMENTS: [
        ...
        OBJECTS: [   
            ...
            // Wochenplan
            {type: GameObjectType.EXPLANATION, position: [3,0], isClickable: true, story: [
                "<b>Montag</b><br><br>9 Uhr: Begrüßungsveranstaltung<br>17 Uhr: Meet-Up",
                "<b>Dienstag</b><br><br>Stand-Up-Meeting<br><i>9 Uhr: Team White<br>9:30 Uhr: Team Blue<br>10 Uhr: Team Orange</i><br><br>17 Uhr: Meet-Up",
                "<b>Mittwoch</b><br><br>Stand-Up-Meeting<br><i>9 Uhr: Team White<br>9:30 Uhr: Team Blue<br>10 Uhr: Team Orange</i><br><br>17 Uhr: Meet-Up",
                "<b>Donnerstag</b><br><br>Stand-Up-Meeting<br><i>9 Uhr: Team White<br>9:30 Uhr: Team Blue<br>10 Uhr: Team Orange</i><br><br>17 Uhr: Studi-Café",
                "<b>Freitag</b><br><br>Stand-Up-Meeting<br><i>9 Uhr: Team White<br>9:30 Uhr: Team Blue<br>10 Uhr: Team Orange</i><br><br>17 Uhr: Abschlusspräsentation",
            ]},
            ...
            {type: GameObjectType.TABLEDECORATION, variation: 23, position: [0,7], isClickable: true, iFrameData: {
                title: "Linksammlung Science Camp Softwareentwicklung", 
                url: "https://media.lehr-lern-labor.info/collab/p/r.3b61740f6afab916eeb3cbc3492c761e?showControls=false&showChat=false&showLineNumbers=false&useMonospaceFont=false&noColors=true&chatAndUsers=false", 
                width: 1000, 
                height: 600 
            }},
            {type: GameObjectType.TABLEDECORATION, variation: 14, position: [2,9], isClickable: true, iFrameData: {
                title: "Ideen, Fragen und Anregungen", 
                url: "https://media.lehr-lern-labor.info/collab/p/SCSE?showControls=false&showChat=false&showLineNumbers=false&useMonospaceFont=false&noColors=true&chatAndUsers=false", 
                width: 1000, 
                height: 600 
            }},
            ...
            {type: GameObjectType.CUPBOARD, variation: 3, position: [5,0], isClickable: true, iFrameData: {
                title: "Montag", 
                url: "https://www.youtube.com/embed/videoseries?list=PLQZMbpPKaFQ-wwBqQFktPV6YRQpm6V98P&rel=0&modestbranding=1", 
                width: 800, 
                height: 450 
            }},
            ...
            {type: GameObjectType.SEATINGAREAORANGE, position: [6,3], isClickable: true, iFrameData: {
                title: "Team Orange", 
        ...
        DOORS: [
            {wallSide: GlobalStrings.LEFT, positionOfDoor: [1, -1], positionOnExit: [Settings.LOUNGE_ID, 12, 4], directionOnExit: Direction.DOWNLEFT},
        ],
        NPCS: []
    },
